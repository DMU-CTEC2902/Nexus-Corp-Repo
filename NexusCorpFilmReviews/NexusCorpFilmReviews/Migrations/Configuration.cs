namespace NexusCorpFilmReviews.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NexusCorpFilmReviews.Models.FilmContext>
    {
        ...
        protected override void Seed(NexusCorpFilmReviews.Models.FilmContext context)
        {
            ...
            context.Genres.AddOrUpdate(genre5);
            ...
            context.Genres.AddOrUpdate(genre6);
            ...
            context.Genres.AddOrUpdate(genre7);
            ...
            context.Genres.AddOrUpdate(genre8);
            ...
            context.Genres.AddOrUpdate(genre9);
            ...
            context.Genres.AddOrUpdate(genre10);
            ...
            //adds the director to the context
            context.Directors.AddOrUpdate(director3);
            ...
            context.ActorComments.AddOrUpdate(actorComment1);
            ...
            context.DirectorComments.AddOrUpdate(directorComment1);
            ...
            context.Gossips.AddOrUpdate(gossip1);
            ...
            //adds he gossip to the context
            context.Gossips.AddOrUpdate(gossip2);
